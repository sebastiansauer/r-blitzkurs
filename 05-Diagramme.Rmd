...
Falls Sie den Datensat `mtcars` nicht geladen haben (er als *nicht* im Reiter *Environment auftaucht),
dann laden Sie den Datensatz noch schnell.
...
Oder Sie schauen im Kapitel [import] noch einmal nach.
