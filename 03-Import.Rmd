...
## SPSS- und Excel-Dateien importieren



Daten in den Formaten von Minitab, SAS, SPSS, Stata, Excel und andere kann man mit dem
...
Oder mit Excel-Daten (.xsl und .xlsx):


```{r echo = TRUE}
excel_path <- "https://file-examples-com.github.io/uploads/2017/02/file_example_XLS_10.xls"
xlsx_path <- "https://file-examples-com.github.io/uploads/2017/02/file_example_XLSX_10.xlsx"
```


```{r}
d2 <- import(excel_path)
head(d2)
```
...
Die Daten stammen aus [dieser Quelle](https://file-examples.com/index.php/sample-documents-download/sample-xls-download/).
